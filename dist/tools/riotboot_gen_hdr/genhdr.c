...
static void populate_hdr(riotboot_hdr_t *hdr, uint32_t ver, uint32_t addr, uint32_t img_size, uint8_t* digest)
{
...
{
    const char generate_usage[] = "<IMG_BIN> <APP_VER> <START_ADDR> <HDR_LEN> <IMG_DIGEST> <outfile|->";
