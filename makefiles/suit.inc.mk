...
#
SUIT_MANIFEST_BASENAME ?= riot$(SUIT_SEPARATOR)suit
SUIT_MANIFEST ?= $(BINDIR_SUIT)/$(SUIT_MANIFEST_BASENAME)_unsigned$(SUIT_SEPARATOR)$(SUIT_SEQNR).bin
SUIT_MANIFEST_LATEST ?= $(BINDIR_SUIT)/$(SUIT_MANIFEST_BASENAME)_unsigned$(SUIT_SEPARATOR)latest.bin
SUIT_MANIFEST_SIGNED ?= $(BINDIR_SUIT)/$(SUIT_MANIFEST_BASENAME)$(SUIT_SEPARATOR)$(SUIT_SEQNR).bin
